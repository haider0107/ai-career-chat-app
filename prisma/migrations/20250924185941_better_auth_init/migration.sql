...
-- AlterTable
ALTER TABLE "public"."ChatSession" ADD COLUMN     "sessionId" TEXT;
...
-- AddForeignKey
ALTER TABLE "public"."ChatSession" ADD CONSTRAINT "ChatSession_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "public"."session"("id") ON DELETE SET NULL ON UPDATE CASCADE;
